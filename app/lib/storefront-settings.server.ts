...
export function parseStorefrontSettingsForm(form: FormData): StorefrontSettings {
  ...
  return mergeSettings({
    ...
    reviews_text_max_chars: num("reviews_text_max_chars", 120),
    reviews_text_max_chars_mobile: num("reviews_text_max_chars_mobile", 85),
    reviews_title_max_chars: num("reviews_title_max_chars", 80),
    reviews_images_initial: num("reviews_images_initial", 2),
    reviews_images_initial_mobile: num("reviews_images_initial_mobile", 2),
    ...
    card_stars_size: num("card_stars_size", 24),
    ...
    card_stars_size_mobile: num("card_stars_size_mobile", 14),
